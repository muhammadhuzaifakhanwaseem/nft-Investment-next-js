            ...
            <Card className="w-full max-w-sm bg-gray-900/50 backdrop-blur-xl border-gray-800/50">
                ...
                <CardContent>
                    <form>
                        ...
                        <div className="relative text-center text-sm mt-6 before:absolute before:inset-0 before:top-1/2 before:z-0 before:flex before:items-center before:border-t before:border-gray-700">
                            <span className="bg-gray-900/50 text-gray-400 relative z-10 px-2">Or continue with</span>
                        </div>
